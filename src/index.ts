...
import * as PropString from './props/string';

export const RequiredString = PropString.RequiredString;
export const DefaultString = PropString.DefaultString;

export const RequiredNumber = PropNumber.RequiredNumber;
export const DefaultNumber = PropNumber.DefaultNumber;
...
export const RequiredObject = PropObject.RequiredObject;
export const DefaultObject = PropObject.DefaultObject;

export const RequiredFunction = PropFunction.RequiredFunction;
export const DefaultFunction = PropFunction.DefaultFunction;
